...
public class PemasukanFragment extends Fragment {
    ...
    private FloatingActionButton mTambahPemasukan;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTambahPemasukan = view_pemasukan.findViewById(R.id.bt_tambah_pemasukan);
...
//        }
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("pemasukan");
        reference2 = FirebaseDatabase.getInstance().getReference().child("saldoPemasukan");
