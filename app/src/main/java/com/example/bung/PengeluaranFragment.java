...
//        }
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("pengeluaran");
        reference2 = FirebaseDatabase.getInstance().getReference().child("saldoPengeluaran");
...
//                Toast.makeText(getContext(), databaseError.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void editPet() {
        ...
        String catatan = pengeluaran.getCatatan();
